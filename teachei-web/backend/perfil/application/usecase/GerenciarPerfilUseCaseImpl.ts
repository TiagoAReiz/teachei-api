import { PerfilNaoEncontradoException } from "@/backend/perfil/domain/exception/PerfilNaoEncontradoException";
import type { GerenciarPerfilUseCase } from "@/backend/perfil/application/ports/in/GerenciarPerfilUseCase";
