...
ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS aceitou_termos BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS aceitou_termos_em TIMESTAMP;
